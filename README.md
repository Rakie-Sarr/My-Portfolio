# Rakie Sarr - Product Engineer Portfolio
...
No additional setup or dependencies required - the portfolio runs entirely in the browser with pure HTML, CSS, and JavaScript.
